...
HD_PWD='C:/Users/jsickafo/lab1/lab1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log myLab1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source myLab1.tcl
