...
HD_PWD='C:/Users/jsickafo/lab1/lab1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log myLab1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source myLab1.tcl -notrace
