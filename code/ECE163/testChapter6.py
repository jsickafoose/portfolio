...
########################################
# VehicleControlGains computeGains() test 1
########################################
testsPassed1 = 0
...
# computeGains() test 2, does the same test again with different random variables
...
########################################
# VehicleControlGains computeTuningParameters() test 1
########################################
testsPassed2 = 0
...
# computeTuningParameters() test 2
transfer = Linearized.transferFunctions(37, 55, 67, 94, 53, 80, 88, 64, 86, 83, 12, 44, 48, 73, 76, 75)
tuneParamsOut = VCG.computeTuningParameters(gainsOut, transfer)
