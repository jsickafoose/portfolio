...
class VehicleGeometry():
	...
	def getNewPoints(self, x, y, z, yaw, pitch, roll):
		...
		#Add offset, rotation NED to ENU from TA section
		#normal rotation -> add offset -> rotation  NED to ENU

		#rotation
		InterialFrame = mm.multiply(newPoints, Rotations.euler2DCM(yaw, pitch, roll)) 

		#add offset
		offset = mm.offset(InterialFrame, x, y, z) 
		
		#NED to ENU
		newPointsENU = Rotations.ned2enu(offset) 
